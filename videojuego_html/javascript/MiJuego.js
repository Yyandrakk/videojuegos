  ...
  var instance = this;
   ...
   this.update = function()  {
    ...
    this.render = function() {
      ...
      this.drawingSurface.fillText("Puntuaci\xF3n:", 50, instance.canvas.height-30);
   ...
   this.initialize = function(canvasId) {
     ...
     // Set up the rendering context
      ...
      this.sprite1 = new AutoAnimatedSprite("Imagenes/plus.png",new Vector2D(0,0),new Vector2D(3,2),
	      new Vector2D(6,4),new Vector2D(75,75),20);
	  this.sprite2 = new AutoAnimatedSprite("Imagenes/threerings.png",new Vector2D(0,0),new Vector2D(2,3),
